            ...
            <div class="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                ...
                <div x-data="{ 
                    ...
                    <button 
                        type="button" 
                        @click="toggle()"
                        class="h-8 w-8 sm:h-9 sm:w-9 rounded-md bg-white/10 hover:bg-white/20 border border-white/20 transition-all duration-200 flex items-center justify-center text-white focus:outline-none focus:ring-2 focus:ring-white/50"
                ...
                <a href="{{ route($notificationsRoute) }}" class="relative h-8 w-8 sm:h-9 sm:w-9 rounded-md bg-white/10 hover:bg-white/20 border border-white/20 transition-all duration-200 flex items-center justify-center text-white focus:outline-none focus:ring-2 focus:ring-white/50">
                    ...
                    <span class="absolute top-0.5 right-0.5 sm:top-1 sm:right-1 h-1.5 w-1.5 sm:h-2 sm:w-2 bg-third-color rounded-full border border-white"></span>
                </a>
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    >
                        <div class="p-3 sm:p-4 border-b border-gray-200 dark:border-slate-700 bg-gradient-to-r from-first-color/5 dark:from-blue-500/10 to-transparent">
                        ...
                        <div class="py-1.5">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="flex items-center gap-2.5 w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm text-third-color dark:text-yellow-400 hover:bg-yellow-50 dark:hover:bg-yellow-500/20 transition-colors duration-150">
